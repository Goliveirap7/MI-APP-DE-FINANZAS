        ...
        <View style={styles.headerRow}>
          ...
          <View style={{ flex: 1, paddingHorizontal: Spacing.md }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
              ...
              {streak > 1 && (
                <View style={{ backgroundColor: colors.bgCardAlt, paddingHorizontal: 6, paddingVertical: 2, borderRadius: Radius.full }}>
                  <Text style={{ fontSize: 12, fontWeight: 'bold', color: '#ff9800' }}>🔥 {streak}</Text>
                </View>
              )}
            </View>
            ...
            >
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: Spacing.sm }}>
                ...
                <TouchableOpacity onPress={() => setIsBalanceHidden(!isBalanceHidden)} hitSlop={{top:10, bottom:10, left:10, right:10}}>
                  <Text style={{ fontSize: 20 }}>{isBalanceHidden ? '👁️' : '🙈'}</Text>
                </TouchableOpacity>
              </View>
...
const getStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  fab: { position: 'absolute', bottom: 80, right: Spacing.lg, width: 58, height: 58, borderRadius: Radius.full, shadowColor: colors.primary, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.5, shadowRadius: 10, elevation: 10 },
